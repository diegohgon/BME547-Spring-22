...
# Using a star is the easiest but the problem is that it is difficult to keep
# your work organized
# Star is considered poor practice
# In your career as a coder you are more likely to spend 2-3x as much time
# reading code as you are writing it


# from analysis import check_HDL
# if you have two packages and within them you have to lines called the same.
# Python will only run the first one
