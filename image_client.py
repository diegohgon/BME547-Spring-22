...
def send_b64_string_to_server(b64_string):
    """
    This funciton makes a post request to the image server.  See the server
    API at
    "https://github.com/dward2/BME547/blob/main/Lectures/
        image_encoding_decoding.md#server-api"
    """
    out_json = {"image": b64_string, "net_id": "dg280", "id_no": 2}
...
def save_image_from_server():
    ...
    """
    r = requests.get(server + "/get_image/dg280/2")
